...
import logo_otp from './logo_otp.svg'
import logo_otp_100 from './logo_otp_100.svg'
...
import slideBackground from './banner-bg.jpg'
...
export const blogCategories = ['All', 'Open Data', 'Digital Government', 'IT Infrastructure','Technology', 'Law']
...
export const footer_data = [
      {
          ...
          links: [
            {label: "หน้าหลัก", path: "/"},
            {label: "โครงสร้าง ศทท.", path: "/"},
            {label: "วิสัยทัศน์และพันธกิจ", path: "/"},   
            {label: "ข่าวประชาสัมพันธ์", path: "/"},
            {label: "การดำเนินงาน", path: "/"},
            {label: "ติดต่อเรา", path: "/"},
         ]
      },
      {
          title: "บริการของ ศทท.",
          links: [
             {label: "ระบบงานบริหารสำนักงานอัตโนมัติ e-Office", path: "https://eoffice.otp.go.th/"},
             {label: "ระบบการเรียนการสอนออนไลน์ e-Learning", path: "https://otpel.otp.go.th/"},
             {label: "ระบบบริหารจัดการข้อมูลส่วนบุคคล สนข. OTP Cloud", path: "http://otpcloud.otp.go.th/"},
             {label: "ระบบการสื่อสารแบบรวมศูนย์ WorkD Platform", path: "https://workd.go.th/"},
             {label: "ระบบแจ้งเตือนการประชุมผ่านสื่ออิเล็กทรอนิกส์ของ สนข", path: "https://docs.google.com/forms/d/1Xzn0OI5mLSfXGc0e8oW7dHXQf1Wc19eLT6RU-od4mwg/viewform?edit_requested=true"},
             {label: "ระบบการตรวจสอบครุภัณฑ์ของ สนข. OTP Inventory", path: "http://otpinventory.otp.go.th/"},
        ]
      },
      {
          title: "ติดตามพวกเรา",
